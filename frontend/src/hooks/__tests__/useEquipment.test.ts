...
describe('Equipment SWR Hooks', () => {
  ...
  describe('Type validation', () => {
    it('should validate equipment types', () => {
      const validTypes = [EquipmentType.EXCAVATOR, EquipmentType.BULLDOZER, EquipmentType.LOADER];
    ...
    it('should validate equipment statuses', () => {
      const validStatuses = [EquipmentStatus.AVAILABLE, EquipmentStatus.IN_USE, EquipmentStatus.MAINTENANCE];
    ...
    it('should validate fuel types', () => {
      const validFuelTypes = [FuelType.DIESEL, FuelType.GASOLINE, FuelType.ELECTRIC];
