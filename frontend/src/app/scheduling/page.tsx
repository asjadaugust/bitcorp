        ...
        <Box display="flex" justifyContent="space-between" alignItems="center" mb={4}>
          <Box>
            ...
            <Typography variant="subtitle1" color="text.secondary">
              Schedule equipment assignments, track availability, and manage project timelines.
            </Typography>
          </Box>
          <Button
            variant="contained"
          ...
          <DialogContent>
            ...
            {scheduleToDelete && (
              <Box mt={2}>
                ...
                <Typography variant="body2" color="text.secondary">
                  <strong>Period:</strong> {formatDateTime(scheduleToDelete.start_datetime)} - {formatDateTime(scheduleToDelete.end_datetime)}
                </Typography>
              </Box>
            )}
          </DialogContent>
