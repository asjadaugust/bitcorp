...
import type { Equipment, EquipmentSearchParams } from '../../types/equipment';
import {
  EquipmentStatus,
  EquipmentType,
  getStatusColor,
...
export const EquipmentList: React.FC<EquipmentListProps> = ({
  ...
  const handleFilterChange = useCallback(
    (field: keyof EquipmentFilters, value: string | number | undefined) => {
  ...
  const handleMenuClick = useCallback(
    (equipment: Equipment, event: React.MouseEvent<HTMLElement>) => {
  ...
  return (
    <Box>
              ...
              <Box display="flex" gap={2} flexWrap="wrap">
                ...
                <FormControl size="small" sx={{ minWidth: 120 }}>
                  ...
                  <Select
                    ...
                    label="Type"
                    onChange={(e) =>
                      handleFilterChange('equipment_type', e.target.value)
                    }
                  >
                    <MenuItem value="">All</MenuItem>
      ...
      >
        ...
        <DialogContent>
          <Typography>
            Are you sure you want to delete &ldquo;{selectedEquipment?.name}
